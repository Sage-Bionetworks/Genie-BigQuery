...
```{r, results='hide'}
sql <- paste(
  "SELECT sample.SAMPLE_ID, mutation.Hugo_Symbol, mutation.Start_Position, sample.PATIENT_ID",
  "FROM (select * from project-genie-query-prod.consortium.mutation where Hugo_Symbol = 'KRAS') as mutation",
  "JOIN project-genie-query-prod.consortium.sample ON sample.SAMPLE_ID = mutation.Tumor_Sample_Barcode"
)
